...
bunny = createSprite(50,200,20,50);
  bunny.addAnimation("running", kangaroo_running);
  bunny.addAnimation("collided", kangaroo_collided);
  bunny.scale = 0.15;
...
bunny.velocityY = bunny.velocityY + 0.8
    ...
    bushes.changeAnimation("collided",kangaroo_collided);
...
function spawnbushes() {
  ...
  if (frameCount % 150 === 0) {
    ...
    switch(rand) {
      case 1: bush.addImage(bush);
              break;
      case 2: carrot.addImage(carrot);
              break;
      default: break;
    }
